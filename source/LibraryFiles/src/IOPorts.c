...
//    PORT_CONFIGURE_PIN_AS_DIGITAL_OUTPUT(BT_PIO7);   // Bidirectional port
    ...
    /* LedDriver */
    PPS_ASSIGN_OUTPUT(SPI1_SDO, PPS_OUT_SDO1);
    PPS_ASSIGN_OUTPUT(SPI1_SCK, PPS_OUT_SCK1OUT);
    /* Anode Control */
    PPS_ASSIGN_OUTPUT(SPI2_SDO, PPS_OUT_SDO2);
    PPS_ASSIGN_OUTPUT(SPI2_SCK, PPS_OUT_SCK2OUT);
    /* USB to UART */
    PPS_ASSIGN_OUTPUT(USB_TO_UART_TX, PPS_OUT_U1TX);
    PPS_ASSIGN_INPUT(PPS_IN_U1RX, USB_TO_UART_RX);
    PPS_ASSIGN_INPUT(PPS_IN_U1CTS, USB_TO_UART_CTS);
    PPS_ASSIGN_OUTPUT(USB_TO_UART_RTS, PPS_OUT_U1RTS);
    /* Bluetooth */
//    PPS_ASSIGN_OUTPUT(BT_UART_TX, PPS_OUT_U2TX);
//    PPS_ASSIGN_INPUT(PPS_IN_U2RX, BT_UART_RX);
//    PPS_ASSIGN_INPUT(PPS_IN_U2CTS, BT_UART_CTS);
//    PPS_ASSIGN_OUTPUT(BT_UART_RTS, PPS_OUT_U2RTS);
    /* Buzzer */
    PPS_ASSIGN_OUTPUT(BUZZER, PPS_OUT_OC1);
